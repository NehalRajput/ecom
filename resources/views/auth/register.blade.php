                            ...
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                ...
                                <form action="{{route('account.processRegister')}}" method="post">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="text" class="form-control @error('name') @enderror" name="name" id="name" placeholder="your name" >
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        <div class="col-12">
                                            <div class="form-floating mb-3">
                                                <input type="email" class="form-control @error('email') @enderror" name="email" id="email" placeholder="name@example.com" >
